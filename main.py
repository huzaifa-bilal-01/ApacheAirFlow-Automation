...
def load():
    os.system('cd /home/kali/airflow/dags/Assignment02_MLOPS && dvc add cleaned_dataset.csv')
    os.system('cd /home/kali/airflow/dags/Assignment02_MLOPS && git add /home/kali/airflow/dags/Assignment02_MLOPS/cleaned_dataset.csv.dvc && git add /home/kali/airflow/dags/Assignment02_MLOPS/main.py')
    os.system('cd /home/kali/airflow/dags/Assignment02_MLOPS && git commit -m "Updated data through airflow"')
    os.system('cd /home/kali/airflow/dags/Assignment02_MLOPS && dvc push')

# Define URLs
urls = [
    {'url': 'https://www.dawn.com/', 'source': 'dawn.com'},
    {'url': 'https://www.thecentersquare.com/', 'source': 'centresquare.com'},
]

file_name = "/home/kali/airflow/dags/Assignment02_MLOPS/dataset.csv"
input_file = file_name
output_file = "/home/kali/airflow/dags/Assignment02_MLOPS/cleaned_dataset.csv"
...
with DAG("my-dag", start_date=datetime.now(), schedule="@daily", catchup=False) as dag:
    ...
    gitPushTask = BashOperator(
        task_id="Git_Push",
        bash_command="git -C /home/kali/airflow/dags/Assignment02_MLOPS push origin master",
    )
